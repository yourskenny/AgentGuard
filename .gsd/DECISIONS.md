...
- 2026-07-08: The demo workbench should start as a static interactive surface backed by normalized sample data, while preserving data-source boundaries for a later live gateway console.
